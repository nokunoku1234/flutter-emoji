...
//      r'(?:[\u2700-\u27bf]|(?:\ud83c[\udde6-\uddff]){2}|[\ud800-\udbff][\udc00-\udfff])[\ufe0e\ufe0f]?(?:[\u0300-\u036f\ufe20-\ufe23\u20d0-\u20f0]|\ud83c[\udffb-\udfff])?(?:\u200d(?:[^\ud800-\udfff]|(?:\ud83c[\udde6-\uddff]){2}|[\ud800-\udbff][\udc00-\udfff])[\ufe0e\ufe0f]?(?:[\u0300-\u036f\ufe20-\ufe23\u20d0-\u20f0]|\ud83c[\udffb-\udfff])?)*');
  ...
  static final String EMOJI_SOURCE =
      'packages/flutter_emoji/json/emoji.json'; // 'https://raw.githubusercontent.com/github/gemoji/master/db/emoji.json';
  ...
  void initLocalData() {
    final mapEmojis = jsonDecode(JSON_EMOJI);
    _init(mapEmojis);
  }
  ...
  void _init(Map<String, dynamic> mapEmojis) {
  ...
  bool hasEmoji(String? emoji) {
    final keys = _emojisByCode.keys;
    for (final key in keys) {
      if ((EmojiUtil.stripNSM(emoji).contains(key))) {
        return true;
      }
    }
    return false;
